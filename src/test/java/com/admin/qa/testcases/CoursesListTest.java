...
public class CoursesListTest extends TestBase {
	...
	public void addCourse() {
		...
		courseDetails.setPhoto("C:\\Users\\SWHIZZ TECHNOLOGIES\\Pictures\\Screenshots\\Screenshot (10).png");
		courseDetails.setCategory("Java");
		...
		courseDetails.setIsPopular("Yess");
